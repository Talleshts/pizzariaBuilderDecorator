...
public class PizzaCalabresaBuilder extends PizzaBuilder {
    ...
    public void prepararMassa() {
        pizza = new PizzaSimples("Massa de Calabresa", 6.00);
    }

    @Override
    public void adicionarMolho() {
        pizza = new IngredienteDecorator(pizza, "Molho de Tomate", 1.50) {};
    }

    @Override
    public void adicionarQueijo() {
        pizza = new IngredienteDecorator(pizza, "Queijo", 2.50) {};
    }
